...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: "Start creating professional Gantt charts in seconds. No tutorials needed.",
      icon: (
    ...
    },
    {
      ...
      description: "Share your timeline instantly. Real-time collaboration without complexity.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Download high-quality PDFs and PNGs with a single click. No waiting.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <main className={`min-h-screen flex flex-col items-center justify-center bg-[#F8F9FA] px-4 sm:px-6 lg:px-8 ${inter.className}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-16 lg:mb-24">
          ...
          >
            <div className="space-y-4 lg:space-y-6">
              ...
              >
                <span className="text-[#FF6B6B] font-medium">The Easiest Gantt Chart Tool</span>
              </motion.div>
              ...
              >
                The simplest way to visualize your project timeline. No login. No learning. Just pure productivity.
              </motion.p>
            </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <p className="text-[#343A40]/60 max-w-2xl mx-auto">
              Powerful features, simple interface. Create, share, and export your Gantt charts with ease.
            </p>
          </motion.div>
